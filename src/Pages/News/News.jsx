               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.4s">
                              <a href="news-detail.html">
                                        <img src={img1} class="img-responsive" alt=""></img>
                              </a>
                              <div class="news-info">
                                   ...
                                   <div class="author">
                                        <img src={auther} class="img-responsive" alt=""></img>
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.6s">
                              <a href="news-detail.html">
                                   <img src={img2} class="img-responsive" alt=""></img>
                              </a>
                              <div class="news-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.8s">
                              <a href="news-detail.html">
                                   <img src={img3} class="img-responsive" alt=""></img>
                              </a>
                              <div class="news-info">
